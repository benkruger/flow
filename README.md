...
The FLOW binary is built from source on first use. From your terminal — not Claude Code — install Rust and a C compiler (one-time per machine), then run the bundled setup script to compile the release binary:
