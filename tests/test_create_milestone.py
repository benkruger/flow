...
spec = importlib.util.spec_from_file_location(
    "create_milestone", LIB_DIR / "create-milestone.py"
)
    ...
    def test_happy_path(self):
        ...
        with patch.object(milestone_mod.subprocess, "run",
            ...
            result, error = milestone_mod.create_milestone(
                "owner/repo", "v1.0 Release", "2026-06-01",
            )
...
class TestMain:
    ...
    def test_main_success(self, capsys):
        ...
        with patch.object(milestone_mod.subprocess, "run",
                          return_value=fake_result), \
             patch("sys.argv", ["create-milestone.py",
                                "--repo", "o/r",
                                "--title", "Sprint 1",
                                "--due-date", "2026-04-01"]):
            milestone_mod.main()
    ...
    def test_main_missing_required_args(self):
        with patch("sys.argv", ["create-milestone.py", "--repo", "o/r"]), \
