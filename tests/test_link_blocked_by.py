...
class TestTombstones:
    """Tombstone tests for body-editing functions removed in PR #697."""

    def test_no_build_blocked_by_section(self):
        """Tombstone: build_blocked_by_section removed in PR #697. Must not return."""
        assert not hasattr(blocked_mod, "build_blocked_by_section"), "build_blocked_by_section was removed in PR #697"

    def test_no_fetch_issue_body(self):
        """Tombstone: fetch_issue_body removed in PR #697. Must not return."""
        assert not hasattr(blocked_mod, "fetch_issue_body"), "fetch_issue_body was removed in PR #697"

    def test_no_update_issue_body(self):
        """Tombstone: update_issue_body removed in PR #697. Must not return."""
        assert not hasattr(blocked_mod, "update_issue_body"), "update_issue_body was removed in PR #697"
