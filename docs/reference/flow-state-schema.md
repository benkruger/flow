...
| `compact_summary` | string / null | Conversation summary from last compaction. Written by PostCompact hook. Currently has no consumer. Transient. |
| `compact_cwd` | string / null | CWD at last compaction time. Written by PostCompact hook. Currently has no consumer. Transient. |
