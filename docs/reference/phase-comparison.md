...
This document captures the full phase analysis from both source projects used as inspiration for ROR Process. Use it to make informed decisions about what to adopt, adapt, or skip.
...
**ROR Process replacement:** Learnings are captured as generic Rails patterns written directly to the project's `CLAUDE.md`.
