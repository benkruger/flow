...
Phase skills that commit (Code, Simplify, Review, Reflect) have both axes. Phase skills that don't commit (Start, Security) only have Continue. Utility skills (Commit, Abort, Cleanup) have a single mode value shown under Commit.
